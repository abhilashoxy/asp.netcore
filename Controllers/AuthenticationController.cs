...
namespace UserService.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public AuthenticationController(IConfiguration config , EmployeeContext context)
        {
        ...
        {
            return await _context.UserDetails.FirstOrDefaultAsync(u => u.EmailId == email && u.Password == password);
        }
    }
}
